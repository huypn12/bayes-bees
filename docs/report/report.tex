...
% title
\title{
  Master Project on Modeling of Complex, Self-organizing systems\\
...
\section{Abstract}
Project aims:
1. Literature survey on Bayesian inference and parameterized population markov
model.
2. Design method for bayesian data-informed parameter synthesis of markov
population model
